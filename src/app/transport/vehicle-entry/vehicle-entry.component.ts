...
public btndisable:boolean=false;
  constructor(public confirmationService: ConfirmationService,public appservice:AppService, private router: Router, private route: ActivatedRoute) { 
    ...
    this.appservice.tpt_type="VEHICLE";
  ...
  addReset() {
    ...
    return this.router.navigate(['/transport/add-vehicle-entry']);
  }
...
Delete(item) {
  ...
  export_excel(data)
  {
    this.appservice.Excel_Data.Header=this.appservice.vehicle_entry_Details_GF ;
