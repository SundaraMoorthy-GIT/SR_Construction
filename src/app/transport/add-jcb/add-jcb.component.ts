...
@Component({
  selector: 'app-add-jcb',
  templateUrl: './add-jcb.component.html',
  styleUrls: ['./add-jcb.component.scss']
})
export class AddJcbComponent implements OnInit {
