...
@Component({
  selector: 'app-tipper-report',
  templateUrl: './tipper-report.component.html',
  styleUrls: ['./tipper-report.component.scss']
})
export class TipperReportComponent implements OnInit {
  ...
  this.appservice.Excel_Data.Report_Name="Tipper Reports";
  this.appservice.Excel_Data.Group_Name=this.S_Transport;
   this.appservice.Excel_Data.Header=this.Tipper_Reports_GF__ ;
