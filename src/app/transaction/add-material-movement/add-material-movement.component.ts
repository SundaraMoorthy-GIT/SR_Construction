...
@Component({
  selector: 'app-add-material-movement',
  templateUrl: './add-material-movement.component.html',
  styleUrls: ['./add-material-movement.component.scss']
})
export class AddMaterialMovementComponent implements OnInit {
  ...
  constructor(public confirmationService: ConfirmationService,public appservice: AppService, private toastr: ToastrService,private router: Router, private http: HttpClient) {
    ...
    if (this.appservice.from_customer_page == true) {
      ...
      this.appservice.header_Row.mm_projectdate = this.appservice.Selected_Customer.est_tenderdate;
      this.appservice.header_Row.mm_projectname = this.appservice.Selected_Customer.est_projectname;
      this.appservice.header_Row.mm_projectid = this.appservice.Selected_Customer.est_deptid;
      this.appservice.header_Row.mm_contact_no = this.appservice.Selected_Customer.est_department;
      this.appservice.header_Row.mm_ledger_name = this.appservice.Selected_Customer.est_office;
  ...
  onChange3(data)
  {
    ...
    this.appservice.header_Row.mm_to=this.ToRow.label;
  }
  ...
  onChange(data)
  {
    ...
    this.appservice.header_Row.mm_godown=this.refRow.label;
    this.To_Area_Rows=this.appservice.To_Area_Rows.filter(e => e.from1 == this.refRow.label);
    //this.get_Stock_Row();
  }
  ...
  onChange1(data)
  {
    this.refRow1=this.appservice.Transport_Rows.filter(e => e.value == data)[0];
    this.appservice.header_Row.mm_transport=this.refRow1.label;
    this.appservice.header_Row.mm_tpttype=this.refRow1.Veh_Make;
  }
  get_Purchase_No() {
...
check_duplicate(data) :boolean
{
  ...
  Place_Order() {
    ...
    this.Rate_Rows=this.appservice.To_Area_Rows.filter(e => e.trm_from == this.appservice.header_Row.mm_godown);
    this.Rate_Rows=this.Rate_Rows.filter(e => e.trm_to.toLowerCase() == this.appservice.header_Row.mm_to.toLowerCase())[0];
    if(this.appservice.header_Row.mm_tpttype=="7U")
    {
      this.appservice.header_Row.mm_tamount=(Number(this.appservice.header_Row.pur_load)*Number(this.Rate_Rows.trm_7U));
      this.appservice.header_Row.mm_stamount=this.Rate_Rows.trm_7U;
    }
    if(this.appservice.header_Row.mm_tpttype=="5.7U")
    {
      this.appservice.header_Row.mm_tamount=(Number(this.appservice.header_Row.pur_load)*Number(this.Rate_Rows.trm_57U));
      this.appservice.header_Row.mm_stamount=this.Rate_Rows.trm_57U;
    }
    if(this.appservice.header_Row.mm_tpttype=="5U")
    {
      this.appservice.header_Row.mm_tamount=(Number(this.appservice.header_Row.pur_load)*Number(this.Rate_Rows.trm_5U));
      this.appservice.header_Row.mm_stamount=this.Rate_Rows.trm_5U;
    }
    if(this.appservice.header_Row.mm_tpttype=="4U")
    {
      this.appservice.header_Row.mm_tamount=(Number(this.appservice.header_Row.pur_load)*Number(this.Rate_Rows.trm_4U));
      this.appservice.header_Row.mm_stamount=this.Rate_Rows.trm_4U;
    }
    if(this.appservice.header_Row.mm_tpttype=="3U")
    {
      this.appservice.header_Row.mm_tamount=(Number(this.appservice.header_Row.pur_load)*Number(this.Rate_Rows.trm_3U));
      this.appservice.header_Row.mm_stamount=this.Rate_Rows.trm_3U;
    }
    if(this.appservice.header_Row.mm_tpttype=="2U")
    {
      this.appservice.header_Row.mm_tamount=(Number(this.appservice.header_Row.pur_load)*Number(this.Rate_Rows.trm_2U));
      this.appservice.header_Row.mm_stamount=this.Rate_Rows.trm_2U;
    }
