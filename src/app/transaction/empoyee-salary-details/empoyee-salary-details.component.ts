...
@Component({
  selector: 'app-empoyee-salary-details',
  templateUrl: './empoyee-salary-details.component.html',
  styleUrls: ['./empoyee-salary-details.component.scss']
})
export class EmpoyeeSalaryDetailsComponent implements OnInit {
  ...
  addReset() {
    ...
    return this.router.navigate(['/transaction/add-empoyee-salary']);
  }
