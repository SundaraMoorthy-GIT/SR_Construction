...
@Component({
  selector: 'app-bunk-details',
  templateUrl:'./bunk-details.component.html',
  styleUrls: ['./bunk-details.component.scss']
})
export class BunkDetailsComponent implements OnInit {
  ...
  constructor(public confirmationService:ConfirmationService,public appservice:AppService,public router:Router) {
   ...
   add()
   {
     ...
     this.router.navigate(['transport/add-bunk-entry']);
   }
